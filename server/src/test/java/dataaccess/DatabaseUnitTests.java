...
public class DatabaseUnitTests {
    ...
    //userSQL tests
    @Test
    void testClearUsers() throws SQLException, DataAccessException {
    ...
    @Test
    void testIsUsernameFreeFail() throws SQLException, DataAccessException {
    ...
    @Test
    void testFindUser() throws DataAccessException, SQLException {
        userDatabase.addUser(new UserData("jonbob", "banana", "email"));
        assertTrue(userDatabase.findUser("jonbob", "banana"));
    }

    @Test
    void testFindUserFail() throws SQLException, DataAccessException {
    ...
    @Test
    void testDeleteAuthDataFail() throws DataAccessException, SQLException {
        assertThrows(UnauthorizedException.class, () -> authDatabase.deleteAuthData("non-existent-token"));
    }

    @Test
    void testAuthTokenExists() throws SQLException, DataAccessException {
    ...
    @Test
    void testAuthTokenExistsFail() {
        assertThrows(UnauthorizedException.class, () -> authDatabase.authTokenExists("non-existent-token"));
    }

    @Test
    void testGetUsername() throws SQLException, DataAccessException {
    ...
    @Test
    void testClearGames() throws SQLException, DataAccessException {
    ...
    @Test
    void testCreateGame() throws SQLException, DataAccessException {
    ...
    @Test
    void testFindGame() throws SQLException, DataAccessException {
        gameDatabase.createGame("game");
        assertTrue(gameDatabase.findGame(1));
    }

    @Test
    void testFindGameFail() throws DataAccessException {
        assertFalse(gameDatabase.findGame(1));
    }

    @Test
    void testListGames() throws SQLException, DataAccessException {
    ...
    @Test
    void testUpdateGame() throws SQLException, DataAccessException {
        gameDatabase.createGame("game");
        assertDoesNotThrow(() -> gameDatabase.updateGame(1, ChessGame.TeamColor.BLACK, "username"));
    }

    @Test
    void testUpdateGameFail() throws SQLException, DataAccessException {
